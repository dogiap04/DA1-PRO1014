            ...
            <div class="row">
                <div class="col-12">
                    ...
                    if ($donHang['trang_thai_id'] == 8) {
                        $coloAlerts = 'primary';
                    } elseif ($donHang['trang_thai_id'] >= 9 && $donHang['trang_thai_id'] <= 16) {
                        $coloAlerts = 'warning';
                    } elseif ($donHang['trang_thai_id'] == 17) {
                        $coloAlerts = 'success';
                    } else {
                        $coloAlerts = 'danger';
                    }
                    ?>
                    <div class="alert alert-<?= $coloAlerts; ?>" role="alert">
