    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-1">
                    <a href="<?= BASE_URL_ADMIN . '?act=san-pham'?>" class="btn btn-primary">Quay lại</a>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select id="trang_thai" name="trang_thai" class="form-control custom-select">
                                    ...
                                    <option <?= $sanPham['trang_thai'] == 2 ? 'selected' : '' ?> value="2">Dừng bán
                                    </option>
                                </select>
                            </div>
                            ...
                            <table id="faqs" class="table table-hover">
                                <thead>
                                    <tr>
                                        <th>Ảnh</th>
                                        <th>File</th>
                                        <th><div class="text-center"><button onclick="addfaqs();"type= "button" class="badge badge-success"><i
                                    class="fa fa-plus"></i> Thêm</button></div></th>
                                    </tr>
                                </thead>
                                <tbody>
                                   <input type="hidden" name="san_pham_id" value="<?= $sanPham['id']?>">
...
<script>
    ...
    function addfaqs() {
        ...
        html += '<td><img src="https:/ben.com.vn/tin-tuc/wp-content/uploads/2021/12/anh-che-cho-hai-huoc-cho-dien-thoai-4.jpg" width="50px" height="50px" alt=""></td>';
